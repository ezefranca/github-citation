...
## Features
- **CITATION.cff Support**: Parses `CITATION.cff` files for accurate citation data.
- **GitHub Metadata Fallback**: Uses GitHub API to generate citations when `CITATION.cff` is missing.
...
2. Click the "Generate BibTeX" button.
3. View the generated BibTeX citation in the output area.
